/* ============================================================
   Populari - master.js  (ES5 / Chromium 78)
   Dataset: D_POPULARI
   Campos:  TEXTO (texto da noticia)  |  FOTO (url da imagem)
   ============================================================ */

var DURATION_MS = 10000;          // tempo de exibicao da noticia antes da vinheta
...
// Vinheta final (outro): WEBM/VP9, um arquivo por formato.
...
/* escolhe o arquivo de vinheta conforme a proporcao da tela */
...
window.onload = function () {
    ...
    // pre-carrega a vinheta do formato atual (arquivo direto de img/) para nao haver corte
    if (videoEl) {
    ...
    /* toca a vinheta do formato atual e so entao finaliza o item da playlist.
         1. play() com som
         2. se a politica de autoplay bloquear -> play() mudo
         3. watchdog / onerror -> finished() garantido, playlist nao trava */
    ...
    window.onresize = function () {
        ajustarTexto(textoEl, textoWrap, 12);
        // mantem a vinheta pre-carregada coerente com o formato (antes de tocar)
