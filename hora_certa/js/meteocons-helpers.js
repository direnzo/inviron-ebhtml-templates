...
/* HORA CERTA: força monochrome com a cor accent do tema */
METEOCONS_STYLE = 'monochrome';
 ...
 * Substitui fill/stroke "black" e "white" por currentColor,
 * preservando fill-rule, transparências e animações dos paths.
...
function aplicarCorSvg(svg, cor) {
  ...
  /* Substitui apenas fill/stroke com valores "black" ou "white"
     por currentColor, preservando o resto (none, fill-rule, etc.) */
  ...
  for (var i = 0; i < els.length; i++) {
    ...
    /* "white" em ícones monochrome é o símbolo interno (ex: % da gota)
       — mantém branco puro como negativo do ícone */
