...
- Segue as mesmas regras técnicas do resto do repositório: ES5, EBHTML 2.0.7 copiado de `_template-base/js/ebhtml.js`, `loader.finished()` sempre, watchdog e retry somente quando aplicável, teste em `http://localhost:12099/FILES/1/index.html`.
...
| `sandbox-loader-retry` | bug de zero itens com dados que deveriam existir (watchdog + retry, ver `ebhtml-api` seção 6) |
