...
function mudaCor() {	
	...
	document.getElementById("container-video").innerHTML = '<video id="the-video"  width="1472" height="912" autoplay muted loop><source src="'+ minutos[minutes] +'" type="video/mp4">Your browser does not support the video tag.</video>';
