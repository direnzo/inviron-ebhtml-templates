        ...
        'D_CONFIG': [
            {
                ...
                DURATION: '40000',
                COMUNICADO_SLIDE_TIME: '9000',
                VIDEO_URL: 'img/video_predios.mp4'
            }
        ],
        'D_COMUNICADOS': [
            {
            ...
            {
                EDITORIA: 'MANUTENÇÃO',
                TITULO: 'Paralisação Programada dos Elevadores — Torre B',
            ...
            {
                EDITORIA: 'COMPLIANCE',
                TITULO: 'Política de Uso das Salas de Reunião — Atualização',
            ...
            {
                EDITORIA: 'LIMPEZA',
                TITULO: 'Higienização Profunda — Lobbies e Áreas de Convivência',
            ...
            {
                EDITORIA: 'AVISOS',
                TITULO: 'Simulado de Evacuação — Brigada de Incêndio 2026',
