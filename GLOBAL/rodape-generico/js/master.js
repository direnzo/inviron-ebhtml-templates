...
window.onload = function () {
    ...
    if (HARDWARE_FRACO) {
        document.body.className += ' hardware-fraco';
    }
    ...
    function aplicarLogo() {
        ...
        if (logoPlaceholder) {
            logoPlaceholder.textContent = CONFIG.logoPlaceholder || 'LOGO';
            logoPlaceholder.style.display = 'inline-flex';
        }
        ...
        xhr.onreadystatechange = function () {
            ...
            if (xhr.status === 200 || xhr.status === 0) {
                ...
                if (!svg) {
                    logoBox.textContent = CONFIG.logoPlaceholder || 'LOGO';
                    return;
                }
    ...
    ebhtml.create2({}, function (loader) {
        ...
        loader.load(function () {
            ...
            iniciarTemplate(dadosCarregados, loader);
                ...
                console.error('[Rodape] Excecao ao processar dados:', erro);
                finalizarPlaylist(loader);
            }
        }, function (erro) {
            clearTimeout(watchdogId);
